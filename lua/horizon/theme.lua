...
theme.set_highlights = function()
  ...
  hl(0, "DiffText", { fg = c.sign_delete, bg = c.sign_delete_bg })
  hl(0, "DiffAdd", { fg = c.sign_add, bg = c.sign_add_bg })
  hl(0, "DiffChange", { fg = c.sign_change, bg = c.sign_change_bg })
  hl(0, "DiffDelete", { fg = c.sign_delete, bg = c.sign_delete_bg })
  ...
  hl(0, "GitSignsAddInline", { fg = c.sign_add, bg = c.sign_add_bg })
  hl(0, "GitSignsDeleteInline", { fg = c.sign_delete, bg = c.sign_delete_bg })
  hl(0, "GitSignsChangeInline", { fg = c.sign_change, bg = c.sign_change_bg })
